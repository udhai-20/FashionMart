...
function Men() {
    ...
    const { kids, isLoading, isError } = useSelector((state) => {
      ...
      const details = "Shop designer clothing for men with price comparison across 500+ stores in one place. Discover the latest designer clothing for men at ModeSens."
