...
function Women() {
    ...
    const { kids, isLoading, isError } = useSelector((state) => {
      ...
      const details = "Shop designer clothing for women with price comparison across 500+ stores in one place. Discover the latest designer clothing for women at ModeSens."
